...
(1, 1, 1, 'Классная компания', '2024-09-01 21:30:03', '1,2,3,4'),
(2, 2, 2, 'Продают китайский шеропотреп', '2024-09-01 21:30:03', '1,2,3,4'),
(3, 3, 3, 'Такая компания вообще существует?', '2024-09-01 21:30:03', '1,2,3,4'),
(4, 4, 4, 'Дефолт на китайском рынке', '2024-09-01 21:30:03', '1,2,3,4'),
(5, 5, 5, 'Мне нравится играть в футбол, а тебе?', '2024-09-01 21:30:03', '1,2,3,4');
...
(1, 'http://localhost:8008/public/example1.png'),
(2, 'http://localhost:8008/public/example2.png'''),
(3, 'http://localhost:8008/public/example3.png'''),
(4, 'http://localhost:8008/public/example4.png'''),
(5, 'http://localhost:8008/public/example5.png''');
...
(1, 'Пурга', 'Сегодня так замело улицу, что я не смог дойти до банкомата, чтобы заплатить за кроссовки', '1,2,3,4'),
(2, 'Капельница', 'Лежал на больничном, теперь не смогу побегать в своих новых кроссовках', '1,2,3,4'),
(3, 'Бутерброд', 'Думал перекусить, но порвал последний кроссовок', '1,2,3,4'),
(4, 'Наташа', 'Сегодня классно провел ночь с Наташкой, мне кажется у нее есть вкус в кроссовках', '1,2,3,4'),
(5, 'Самолет', 'Когда выпрыгивал с парашутом забыл свои найки в багаже(', '1,2,3,4');
...
(1, 'Носки дольчигабана', '1000.00', 'Дизайнерская носки дольчигабиба', 1, 1, 1, '1,2'),
(2, 'Майка скуфа', '1000.00', 'Дизайнерская майка дольчигабиба', 2, 2, 2, '1,2'),
(3, 'Кроссы с юпитера', '1000.00', 'Дизайнерская кроссы дольчигабиба', 3, 3, 3, '1,2'),
(4, 'Найки без подошовы', '1000.00', 'Дизайнерская найки дольчигабиба', 4, 4, 4, '1,2'),
(5, 'Юность new balance', '1000.00', 'Дизайнерская кроссовки дольчигабиба', 5, 5, 5, '1,2');
...
(2, 2, 2, 'Сосно', '2024-09-01 22:04:54', '1,2,3,4'),
...
(3, 'Коля', 'Ермолин', 3, 3, 'user'),
(4, 'Коля', 'Ермолин', 4, 4, 'user'),
(5, 'Коля', 'Ермолин', 5, NULL, 'user');
